...
// import used with test bed from angular testing core (SNHU, 2023, p. 1)
import { TestBed } from '@angular/core/testing';

// import used within the authentication service (SNHU, 2023, p. 1)
import { AuthenticationService } from './authentication.service';

// describes the authentication service (SNHU, 2023, p. 1)
describe('AuthenticationService', () => {
  beforeEach(() => TestBed.configureTestingModule({}));

  // assert the authentication service to be trusted (SNHU, 2023, p. 1)
