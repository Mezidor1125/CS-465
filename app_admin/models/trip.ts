...
// export used to interface the trip schema within the application (SNHU, 2023, p. 1)
export interface Trip {
    _id: string, // internal MongoDB primary key
    code: string, // trip code within application
    name: string, // trip name within application
    length: string, // trip length within application
    start: Date, // start of the trip date within application
    resort: string, // resort name within application
    perPerson: string, // price per person within application
    image: string, // image file specified within application
    description: string  // description of trip within application
   }