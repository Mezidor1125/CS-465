...
// import used in the ng module within angular framework (SNHU, 2023, p. 1)
import { NgModule } from '@angular/core';

// import used in the routes and router module within angular framework (SNHU, 2023, p. 1)
import { Routes, RouterModule } from '@angular/router';

// import used in the trip listing component within the application (SNHU, 2023, p. 1)
import { TripListingComponent } from './trip-listing/trip-listing.component';

// import used in the add trip component within the application (SNHU, 2023, p. 1)
