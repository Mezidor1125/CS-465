...
// import used for component within angular framework (SNHU, 2023, p. 1)
import { Component } from '@angular/core';

// components which utilize the selector, templateurl and style urls within application (SNHU, 2023, p. 1)
@Component({
  selector: 'app-root',
...
// variable title which holds the title of page within application (SNHU, 2023, p. 1)
