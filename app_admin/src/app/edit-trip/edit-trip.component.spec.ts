...
// import used for the edit trip component within application (SNHU, 2023, p. 1)
...
describe('EditTripComponent', () => {
  ...
  // declarations used for the edittripcomponent within application while compiling the components during the last step (SNHU, 2023, p. 1)
  beforeEach(async(() => {
  ...
  // create each fixture utilizing the Test Bed import for each edit trip component, obtain an instance of the component, and detect any changes in the fixture (SNHU, 2023, p. 1)
  beforeEach(() => {
