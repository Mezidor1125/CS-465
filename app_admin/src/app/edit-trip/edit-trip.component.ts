...
// Compart, C. (2022, March 3). Find all unicode characters from hieroglyphs to dingbats – unicode compart. https://www.compart.com/en/unicode/U+27. Retrieved April 29, 2023, from https://www.compart.com/en/unicode/U+2753 
...
// import utilized within the component and oninit angular framework (SNHU, 2023, p. 1)
import { Component, OnInit } from '@angular/core';

// import utilized within the router angular framework (SNHU, 2023, p. 1)
import { Router } from "@angular/router";

// import utilized within the formbuilder, formgroup, and validators classes angular framework (SNHU, 2023, p. 1)
...
export class EditTripComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.editForm = this.formBuilder.group({
      ...
      name: ['', Validators.required], // name validation (SNHU, 2023, p. 1)
      length: ['', Validators.required], // length of stay validation (SNHU, 2023, p. 1)
      start: ['', Validators.required], // start date validation (SNHU, 2023, p. 1)
      resort: ['', Validators.required], // resort name validation (SNHU, 2023, p. 1)
      perPerson: ['', Validators.required], // price per person validation (SNHU, 2023, p. 1)
      image: ['', Validators.required], // image file validation (SNHU, 2023, p. 1)
      description: ['', Validators.required], // description validation (SNHU, 2023, p. 1)
    })
  ...
  // submit which sets the submitted variable to true when user selects to submit the form, checks for condition to make sure the form is valid,
  // if the form is valid, call the update trip function with the values from the form, and pass the data to the console and navigate to the
