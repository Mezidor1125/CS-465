...
// import used for browser module form angular framework (SNHU, 2023, p. 1)
import { BrowserModule } from '@angular/platform-browser';

// import used for NgModule form angular framework (SNHU, 2023, p. 1)
import { NgModule } from '@angular/core';

// import used forHTTPModule form angular framework (SNHU, 2023, p. 1)
import { HttpModule } from '@angular/http';

// import used for reactive forms module form angular framework (SNHU, 2023, p. 1)
import { ReactiveFormsModule } from "@angular/forms";

// import used for app component form angular framework (SNHU, 2023, p. 1)
import { AppComponent } from './app.component';

// import used for app routing moduleform angular framework (SNHU, 2023, p. 1)
import { AppRoutingModule } from './app-router.module';

// import used for trip listing component form angular framework (SNHU, 2023, p. 1)
import { TripListingComponent } from './trip-listing/trip-listing.component';

// import used for trip card component form angular framework (SNHU, 2023, p. 1)
import { TripCardComponent } from './trip-card/trip-card.component';

// import used for trip data service form angular framework (SNHU, 2023, p. 1)
import { TripDataService } from '../../services/trip-data.service';

// import used for add trip component form angular framework (SNHU, 2023, p. 1)
