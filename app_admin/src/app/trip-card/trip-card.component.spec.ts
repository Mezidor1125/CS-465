...
// import used for the trip card component within application (SNHU, 2023, p. 1)
...
describe('TripCardComponent', () => {
  ...
  // declarations used for the tripcardcomponent within application while compiling the components during the last step (SNHU, 2023, p. 1)
  beforeEach(async(() => {
  ...
  // create each fixture utilizing the Test Bed import for each trip card component, obtain an instance of the component, and detect any changes in the fixture (SNHU, 2023, p. 1)
  beforeEach(() => {
