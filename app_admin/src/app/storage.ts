...
// import used for injection token from angular core framework (SNHU, 2023, p. 1)
import { InjectionToken } from '@angular/core';

// export used on browser storage variable used with injection token provided by the root and stored into local storage (SNHU, 2023, p. 1)
