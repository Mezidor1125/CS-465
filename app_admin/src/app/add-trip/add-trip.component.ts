...
export class AddTripComponent implements OnInit {
  ...
  ngOnInit() {
    this.addForm = this.formBuilder.group({
      ...
      length: ['', Validators.required], // length of time validation (SNHU, 2023, p. 1)
  ...
  // if the form is valid, call the add trip function with the values from the form, and pass the data to the console and navigate to the
