...
// import used for the add trip component within application (SNHU, 2023, p. 1)
...
describe('AddTripComponent', () => {
  ...
  // declarations used for the addtripcomponent within application while compiling the components during the last step (SNHU, 2023, p. 1)
  beforeEach(async(() => {
  ...
  // create each fixture utilizing the Test Bed import for each add trip component, obtain an instance of the component, and detect any changes in the fixture (SNHU, 2023, p. 1)
  beforeEach(() => {
