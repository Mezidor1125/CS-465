...
// import used for the async, component fixture, and test bed from angular framework (SNHU, 2023, p. 1)
import { async, ComponentFixture, TestBed } from '@angular/core/testing';


// import used for the trip listing component within application (SNHU, 2023, p. 1)
...
describe('TripListingComponent', () => {
  ...
  // declarations used for the triplistingcomponent within application while compiling the components during the last step (SNHU, 2023, p. 1)
  beforeEach(async(() => {
  ...
  // create each fixture utilizing the Test Bed import for each trip listing component, obtain an instance of the component, and detect any changes in the fixture (SNHU, 2023, p. 1)
  ...
  // assertion that states the component is created (SNHU, 2023, p. 1)
  it('should create', () => {
