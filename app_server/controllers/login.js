...
/* GET login view (SNHU, 2023, p. 1) */

// const login variable that is used to set the declared function which takes the paramters req and res (SNHU, 2023, p. 1)
const login = (req, res) => {
    
    // function used to render view and send the rendered HTML string to the client, meaning sends the title Travlr Getaways to the client denoted by login (GeeksForGeeks, 2023, p. 1);(SNHU, 2023, p. 1)
    res.render('login', {title: 'Travlr Getaways', logins });
};

// object in the Node.js file that holds the exported values and functions from that module, in the case of it being the module exporting to the login variable (Megida, 2022, p. 1);(SNHU, 2023, p. 1)
module.exports = {
    login
};