...
// required variable that parses the contents of the file and inserts them into the user variable (SNHU, 2023, p. 1)
...
const users = (req, res) => {
    ...
    // function used to render view and send the rendered HTML string to the client, meaning sends the title Travlr Getaways to the client denoted by users (GeeksForGeeks, 2023, p. 1);(SNHU, 2023, p. 1)
    res.render('users', { title: 'Travlr Getaways', user });
};

// object in the Node.js file that holds the exported values and functions from that module, in the case of it being the module exporting to the users variable (Megida, 2022, p. 1);(SNHU, 2023, p. 1)
module.exports = {
    users
};